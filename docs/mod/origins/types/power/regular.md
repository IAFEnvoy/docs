...
This example will make all entities outside the arthropod entity type tag glow when they're in cobwebs. The glow is the same color as the entity's team.
